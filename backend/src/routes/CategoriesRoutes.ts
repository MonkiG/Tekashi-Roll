...
export default class CategoriesRoutes {
  ...
  constructor () {
    this.#router.post(CategoriesRoutes.addCategory, AuthMiddlewares.isAdmin, CategoryControllers.addCategory)
    this.#router.get(CategoriesRoutes.getCategories, CategoryControllers.getCategories)
    this.#router.get(CategoriesRoutes.getCategory, CategoryControllers.getCategory)
    this.#router.patch(CategoriesRoutes.editCategory, AuthMiddlewares.isAdmin, CategoryControllers.editCategory)
    this.#router.delete(CategoriesRoutes.deleteCategory, AuthMiddlewares.isAdmin, CategoryControllers.deleteCategory)
  }
