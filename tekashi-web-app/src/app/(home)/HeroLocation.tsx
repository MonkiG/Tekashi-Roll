    ...
    return(
        <span className='inline-flex items-center bg-gray-500 rounded-md p-2 m-5'>
            ...
            <div className='flex flex-col ml-2 leading-4'>
                <small className='text-gray-300 py-1'>{parseredPosition && parseredPosition.label}</small>
                <strong className='text-gray-200 py-1'>{parseredPosition && parseredPosition.position}</strong> {/* Obtener ubicacion mediante el navegador */}
            </div>
        </span>
    )
}