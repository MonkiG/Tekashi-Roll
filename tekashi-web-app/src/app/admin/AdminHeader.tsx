...
export default function AdminHeader ({ className }: { className?: string }): JSX.Element {
  return (
        <header className={`relative grid grid-rows-1 grid-cols-12 items-center w-full bg-page-black bg-header-image bg-right bg-no-repeat bg-[length:12%] h-[72px] ${className}`}>
            ...
            <Link href={'/admin/products'} className='text-white hidden lg:block hover:bg-page-black-hover text-center rounded-md p-2'>Productos</Link>
            <Link href={'/admin/orders'} className='text-white hidden lg:block hover:bg-page-black-hover text-center rounded-md p-2'>Pedidos</Link>
