        ...
        <figure className=''>
          ...
          <div className='flex justify-between items-center px-2 mt-2'>
            ...
            <div className='w-1/2 flex items-center justify-end'>
              <button onClick={handleDescription} className='flex justify-center items-center bg-transparent rounded-full hover:bg-[rgba(0,0,0,0.1)] w-10 h-10' title='See product description'>
                <Description />
              </button>
              <button
